  ...
  <section class="bg-primary">
    ...
    <div class="col-lg-10 col-lg-offset-1 text-center">
      <h1>Juegos de Arcade<h1>
        ...
        $categoria = "SELECT * from juegos where categoria='2'";
        ...
        <div>
          ...
          <input type="button" value="Abrir el juego" class="btn btn-primary" onclick="this.nextSibling.style.display='block';this.style.display='none' "/><div class="spoiler">

            <?php
            echo "<embed width='1024px' height='840px' name='plugin' id='plugin' src='$arrayResultado[3]' type='application/x-shockwave-flash'>";

            ?>
            <!-- Formulario para pasar la ID del juego y guardarlo en la lista de favoritos -->

            <form class="" action="guardafavoritos.php" method="post">
              <?php
              echo "<input name='juego' type='text' value='$arrayResultado[0]' style='display:none'</input>";
              ?>
              <button type="submit" name="button" class="btn btn-primary">Guardar en favoritos</button>
            </form>
          </div>
        </div>
        <div>
